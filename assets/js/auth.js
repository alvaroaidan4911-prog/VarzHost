    ...
    if (registerForm) {
        registerForm.addEventListener('submit', async (e) => {
            ...
            try {
                ...
                const response = await fetch('https://chairs-continued-deserve-sunday.trycloudflare.com/api/auth/register', {
                    method: 'POST',
                    headers: {
    ...
    if (loginForm) {
        loginForm.addEventListener('submit', async (e) => {
            ...
            try {
                ...
                const response = await fetch('https://chairs-continued-deserve-sunday.trycloudflare.com/api/auth/login', {
                    method: 'POST',
