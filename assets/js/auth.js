    ...
    if (registerForm) {
        registerForm.addEventListener('submit', async (e) => {
            ...
            try {
                ...
                const response = await fetch('https://basis-nose-genealogy-segments.trycloudflare.com/api/auth/register', {
                    method: 'POST',
                    headers: {
    ...
    if (loginForm) {
        loginForm.addEventListener('submit', async (e) => {
            ...
            try {
                ...
                const response = await fetch('https://basis-nose-genealogy-segments.trycloudflare.com/api/auth/login', {
                    method: 'POST',
