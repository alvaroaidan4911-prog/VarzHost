...
async function loadHostingPlans() {
    try {
        const response = await fetch('https://smoke-sells-spyware-include.trycloudflare.com/api/hosting/plans');
...
async function orderPlan(planId) {
    ...
    try {
        ...
        const response = await fetch('https://smoke-sells-spyware-include.trycloudflare.com/api/payments/checkout', {
            method: 'POST',
            headers: {
