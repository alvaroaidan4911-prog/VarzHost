...
async function loadHostingPlans() {
    try {
        const response = await fetch('https://keeping-north-proudly-turner.trycloudflare.com/api/hosting/plans');
...
async function orderPlan(planId) {
    ...
    try {
        ...
        const response = await fetch('https://keeping-north-proudly-turner.trycloudflare.com/api/payments/checkout', {
            method: 'POST',
            headers: {
