...
async function loadHostingPlans() {
    try {
        const response = await fetch('https://chairs-continued-deserve-sunday.trycloudflare.com/api/hosting/plans');
...
async function orderPlan(planId) {
    ...
    try {
        ...
        const response = await fetch('https://chairs-continued-deserve-sunday.trycloudflare.com/api/payments/checkout', {
            method: 'POST',
            headers: {
